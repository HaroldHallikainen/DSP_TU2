...
int main ( void ){
  ...
  uint8_t RxChar;
  WDTCONSET = 0x01;           // Clear WDT. Prescale is 1024 for timeout in 1.024 seconds
  ...
  // Test ext flash write and read
  //StreamProgramExtFlash(0,12,(uint8_t*)"Hello World!"); // Test write to flash
  // ReadExtFlashArray(0,(uint8_t*)StringBuf,12);
  DisplayClear();
  while ( true ){
